...
func BasePipeline() *Pipeline {
	return &Pipeline{
		...
		Steps: []Step{
			...
			{Key: "err_work", Kind: KindAgent, Title: "Работа над ошибками", Skill: "plan-review", Passes: 2,
			...
			{Key: "execute", Kind: KindAgent, Title: "Выполнение", Skill: "execute-plan",
			...
			{Key: "review", Kind: KindAgent, Title: "Ревью", Skill: "review-task",
			...
			{Key: "handoff", Kind: KindAgent, Title: "Инструкция по проверке", Skill: "handoff-notes",
